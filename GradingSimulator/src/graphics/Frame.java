 ...
 * It also creates the CardLayout that is necessary for switching between the pages of the Studeng
 * Grading Simulator.
 * 
...
public class Frame extends JFrame implements ActionListener {
	 ...
	 * as is all the buttons and panels involved with the CardLayout. 
	 * 
	...
	public String toString() {
		return "Frame [cl=" + cl + ", container=" + container + ", buttonPageOneStartUp=" + buttonPageOneStartUp
